...
addMarkerButton.addEventListener('click', () => {
  ...
  if (description && selectedCoordinates) {
    ...
    marker.setStyle(
      new Style({
        image: new Icon({
          src: 'https://png.pngtree.com/png-clipart/20230423/original/pngtree-football-line-icon-png-image_9077630.png',
          scale: 0.05,
        }),
      })
    );
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        if (nearestLocation) {
          ...
          Swal.fire({
            title: "Ayo Tandakan Tempat futsal  Di Dekat Anda",
            text: ``,
            icon: "info",
          });
        }
...
const parkingLocations = [
  { name: "Tempat futsal A", coordinates: [107.580642, -6.883722] },
  { name: "Tempat futsal B", coordinates: [107.579529, -6.882788] },
];
